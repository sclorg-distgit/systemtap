...
# PRERELEASE
%changelog
* Fri Oct 18 2019 Frank Ch. Eigler <fche@redhat.com> - 4.1-6
- bz1741895 unwind-data (binutils extra segment)

* Thu Oct 10 2019 Frank Ch. Eigler <fche@redhat.com> - 4.1-5
- drop pyparsing require for /usr/bin/dtrace on rhel6
